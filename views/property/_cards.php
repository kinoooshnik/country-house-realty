...
<?php
        $url = Url::to(['/property/view', 'slug' => $propertyView->property_slug]);
    ?>
<?= $key % 3 == 0 ? '<div class="card-deck">' : '' ?>
<div class="card mb-3">
	<a href="<?= $url?>"><img class="card-img-top" src="<?= Yii::getAlias('@propertyOpiginalPhotoUploadDir/') . $propertyView->photos[0]['photoPath'] ?>"
